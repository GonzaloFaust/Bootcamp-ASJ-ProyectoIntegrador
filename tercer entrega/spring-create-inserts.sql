...
CREATE TABLE suppliers
  (
     ...
     sup_contact_id     INT NOT NULL REFERENCES suppliers_contacts(
     sup_contact_id),
...
INSERT INTO suppliers_contacts
            (sup_contact_name,
             sup_contact_lastname,
             sup_contact_telephone,
             sup_contact_email,
             sup_contact_role,
             created_at)
VALUES      ('Juan',
            ...
            ('Carmen',
             'Ramírez',
             '5566778899',
             'carmen.ramirez@example.com',
             'Servicio al cliente',
             '2024-01-09'),
            ('Ricardo',
             'Gutiérrez',
             '2233445566',
             'ricardo.gutierrez@example.com',
             'Ejecutivo de cuentas',
             '2024-01-10'),
            ('Laura',
             'Morales',
             '1122334455',
             'laura.morales@example.com',
             'Gerente de ventas',
             '2024-01-11'),
            ('Javier',
             'Hernández',
             '6677889900',
             'javier.hernandez@example.com',
             'Representante de ventas',
             '2024-01-12'),
            ('Sofía',
             'Castro',
...
INSERT INTO fields
            (field_name,
             ...
             created_at)
VALUES      ('Tecnología',
'Empresas dedicadas a la producción de tecnología y servicios relacionados',
Getdate()),
            ('Salud',
             'Empresas y proveedores que ofrecen productos y servicios de salud'
             ,
             Getdate()),
            ('Alimentación',
             'Empresas y proveedores que producen y distribuyen alimentos',
             Getdate()),
            ('Educación',
             'Empresas y proveedores que ofrecen servicios educativos',
             Getdate()),
            ('Construcción',
'Empresas y proveedores relacionados con la industria de la construcción',
Getdate() );
...
INSERT INTO categories
            (cat_name,
             ...
             created_at)
VALUES      ('Hardware',
             'Productos de hardware y componentes electrónicos',
             '2024-01-16'),
            ('Software',
             'Productos de software y aplicaciones',
             '2024-01-17'),
            ('Dispositivos móviles',
             'Smartphones, tablets y otros dispositivos móviles',
             '2024-01-18'),
            ('Accesorios',
            ...
            ('Productos de cuidado personal',
             'Productos para el cuidado personal y la higiene',
             '2024-01-25'),
            ('Comida enlatada',
            ...
            ('Productos lácteos',
             ...
             '2024-01-28'),
            ('Carnes',
             'Carnes rojas, blancas y productos cárnicos',
             '2024-01-29'),
            ('Frutas y verduras',
             'Frutas, verduras y hortalizas frescas',
             '2024-01-30'),
            ('Libros de texto',
             'Libros de texto y manuales educativos',
             '2024-01-31'),
            ('Cursos online',
             'Cursos y formación online',
             '2024-02-01'),
            ('Material de oficina',
             'Material de oficina y suministros escolares',
             '2024-02-02'),
            ('Software educativo',
             'Software y aplicaciones educativas',
             '2024-02-03'),
            ('Servicios de tutoría',
             'Servicios de tutoría y apoyo educativo',
             '2024-02-04'),
            ...
            ('Servicios de construcción',
             'Servicios de construcción y contratistas',
             '2024-02-07'),
            ('Maquinaria pesada',
             'Maquinaria pesada y vehículos de construcción',
             '2024-02-08'),
            ('Suministros de plomería',
             'Suministros de plomería y accesorios',
             '2024-02-09');
...
VALUES      ('P001',
            ...
            ('P002',
             ...
             'Kit de primeros auxilios esencial',
             50.00,
             '2024-01-02'),
            ('P003',
             3,
            ...
            ('P004',
             ...
             'Libro de texto para el estudio de las matemáticas',
             30.00,
             '2024-01-04'),
            ('P005',
             5,
             ...
             'Martillo resistente para construcción',
             25.00,
             '2024-01-05'),
            ('P006',
             6,
            ...
            ('P008',
             ...
             'Sofá cómodo para la sala de estar',
             500.00,
             '2024-01-08'),
            ('P009',
             9,
             17,
             'Juego de mesa',
             'Juego de mesa divertido para toda la familia',
             35.00,
             '2024-01-09'),
            ('P010',
             10,
            ...
            ('P012',
             ...
             8,
             'Software antivirus',
             'Software antivirus para proteger tu computadora',
             60.00,
             '2024-01-12'),
            ('P013',
             13,
             13,
             'Teléfono móvil',
             'Teléfono móvil con las últimas características',
             800.00,
             '2024-01-13'),
            ('P014',
             14,
             18,
             'Pintura al óleo',
             'Hermosa pintura al óleo para decorar tu hogar',
             120.00,
             '2024-01-14'),
            ('P015',
             15,
